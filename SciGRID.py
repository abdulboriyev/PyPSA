...
# Load all data
demand_data = pd.read_csv("example/demand_data.csv", parse_dates=["timestamp"], index_col="timestamp")
power_plants = pd.read_csv("example/power_plants.csv")
transmission_data = pd.read_csv("example/transmission_data.csv")
fuel_costs = pd.read_csv("example/fuel_costs.csv")
